...
class CtrlSigs extends Bundle with HILOWen {
  ...
  private val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    BEQ -> List(SEL_ALU1_RS, SEL_ALU2_RT, SEL_IMM_B, FN_SLT, 0, 0, 0, 0, XX, XXX, BR_TYPE_EQ, 0, 0, 0),
    BLTZ -> List(SEL_ALU1_RS, SEL_ALU2_ZERO, SEL_IMM_B, FN_SLT, 0, 0, 0, 0, XX, XXX, BR_TYPE_LT, 0, 0, 0),
